    ...
    <section ref={ref} className="py-32 px-6 bg-white">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.h2
          ...
          className="text-4xl sm:text-5xl font-black tracking-tight text-stone-900 mb-12 leading-tight"
        >
        ...
        <div className="flex flex-col sm:flex-row gap-10 items-start">
          ...
          <motion.div
            ...
            className="shrink-0"
          >
            <div className="w-24 h-24 rounded-full bg-stone-100 border border-stone-200 flex items-center justify-center text-4xl">
              🏃
            </div>
          </motion.div>
          ...
          <div className="space-y-5">
            {[p[0], p[1], null, p[4]].map((text, i) => {
              if (i === 2) {
                return (
                  ...
                  >
                    {p[2]}{" "}
                    <span className="text-stone-900 italic">{p[3]}</span>
                  </motion.p>
                );
              }
              return (
            ...
            <motion.p
              ...
              className="text-stone-400 text-sm pt-2"
            >
